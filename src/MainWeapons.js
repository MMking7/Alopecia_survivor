  ...
  mzamen: [
    {
      ...
      description: '부메랑이 돌아올 때 주는 피해 증가',
      icon: 'mzamen_skill1',
      maxLevel: 3,
      levels: [
        { returnDamageBonus: 0.10 },
        { returnDamageBonus: 0.20 },
        { returnDamageBonus: 0.30 },
      ],
    },
    {
      id: 'mzamen_skill2',
      ...
      description: '픽업 범위 증가, 경험치 구슬 획득 시 10% 확률로 HP 회복',
      icon: 'mzamen_skill2',
      maxLevel: 3,
      levels: [
        { pickupRange: 0.20, xpHealPercent: 0.03, xpHealChance: 0.10 },
        { pickupRange: 0.30, xpHealPercent: 0.04, xpHealChance: 0.10 },
        { pickupRange: 0.40, xpHealPercent: 0.05, xpHealChance: 0.10 },
      ],
    },
    {
      id: 'mzamen_skill3',
