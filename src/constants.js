...
export const SPRITES = {
  ...
  bosses: {
    original: '/sprites/bosses/boss_ame.webp',
    subway: '/sprites/bosses/boss_subway.webp',
    airraid: '/sprites/bosses/boss_airraid.webp',
  },
  characters: {
    female: '/sprites/femalebald/base.webp',
    areata: '/sprites/areata/base.webp',
    wongfeihung: '/sprites/wongfeihung/base.webp',
    heihachi: '/sprites/heihachi/base.webp',
  ...
  enemies: {
    ...
    clipper: '/sprites/enemies/clipper.webp',
    zombie: '/sprites/enemies/zombie.webp',
    dna: '/sprites/enemies/dna.webp',
    cigarette: '/sprites/enemies/cigarette.webp',
    soju: '/sprites/enemies/soju.webp',
    cigarette_projectile: '/sprites/enemies/cigarette_projectile.png',
    shield_guy: '/sprites/shield/shield_char_animation.png',
  },
  boss: '/sprites/bosses/boss_ame.webp',
  ui: {
    title: '/sprites/holo/title.webp',
    menu: '/sprites/ui/menu.jpg',
...
export const BOSSES = [
  {
    ...
    type: 'boss',
    name: 'Smol Ame (Boss)',
    sprite: '/sprites/bosses/boss_ame.webp',
    speed: 80,
    hp: 2000,
    damage: 40,
    xp: 1000,
  ...
  },
  {
    ...
    type: 'boss_subway',
    name: '지하철의 제왕',
    sprite: '/sprites/bosses/boss_subway.webp',
    speed: 40,
    hp: 20000,
    damage: 60,
    xp: 5000,
